...
namespace Wisol.MES.Forms.SETTING
{
    public partial class SETTING002 : PageType
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SETTING002.GET_DEVICE"
        ...
        private void btnINbinhcuuhoa_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SETTING002.GET_BCH"
                    , new string[] { "A_PLANT","A_DEPARTMENT", "A_TRAN_USER", "A_LANG", "A_CODE"
                    }
        ...
        private void btnINbinhcuuhoa1_Click(object sender, EventArgs e)
        {
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SETTING002.GET_PRINT_ALL"
                    , new string[] { "A_PLANT"
                    }
                ...
                if (base.m_ResultDB.ReturnInt == 0)
                {
                    ...
                    {
                        print.PrintBCH(0, 0, dt.Rows[i][0].ToString());
                    }
                }
                else
                {

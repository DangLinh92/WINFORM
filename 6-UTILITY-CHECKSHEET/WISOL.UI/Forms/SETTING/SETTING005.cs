...
namespace Wisol.MES.Forms.SETTING
{
    public partial class SETTING005 : PageType
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SETTING005.PUT_SAVE"
                    , new string[] { "A_PLANT","A_DEPARTMENT", "A_TRAN_USER", "A_LANG",
        ...
        {
            base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SETTING005.GET_ITEM"
        ...
        private void btnEditItemCheck_Click(object sender, EventArgs e)
        {
            ...
            POP.POP_SETTING005_1 popup = new POP.POP_SETTING005_1(device_id, code, device_name, id_check, name, min, max, other);
            popup.ShowDialog();
        ...
        private void btnDeleteItemCheck_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.OK)
            {
                try
                {
                    base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SETTING005.DELETE_ITEM_CHECK"
        ...
        {
            POP.POP_SETTING005_3 popup = new POP.POP_SETTING005_3(dt_factory, dt_location);
            popup.ShowDialog();
            this.SearchPage();
        }
        ...
        private void btnDeleteDevice_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.OK)
            {
                try
                {
                    base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SETTING005.DELETE_DEVICE"
                        , new string[] { "A_PLANT", "A_DEPARTMENT", "A_TRAN_USER", "A_LANG", "A_CODE"
                        }

...
namespace Wisol.MES.Forms.SETTING
{
    public partial class SETTING009 : PageType
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SETTING009.PUT_SAVE"
                    , new string[] { "A_PLANT","A_DEPARTMENT", "A_TRAN_USER", "A_LANG",
        ...
        {
            POP.POP_SETTING009_1 popup = new POP.POP_SETTING009_1(dt_factory, dt_location);
            popup.ShowDialog();
            this.SearchPage();
        }
        ...
        private void btnCopy_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SETTING009.COPY_ITEM"
                    , new string[] { "A_PLANT","A_DEPARTMENT", "A_TRAN_USER", "A_LANG",

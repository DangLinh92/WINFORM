...
namespace Wisol.MES.Forms.SETTING
{
    public partial class SETTING008 : PageType
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SETTING008.PUT_SAVE"
                    , new string[] { "A_PLANT","A_DEPARTMENT", "A_TRAN_USER", "A_LANG",
                                     "A_DEVICE_ID", "A_DEVICE_NAME", "A_LOCATION_ID", "A_TIME_SETUP","A_CODE"
                    }
                    , new string[] { Consts.PLANT, "", Consts.USER_INFO.Id, 
                                     Consts.USER_INFO.Language,
                                     txtDeviceID.Text, txtDeviceName.Text.Trim(), 
                                     gleLocation.EditValue.ToString(),
                                     dtpTimeSetup.Text.NullString(),
                                     txtCode.Text.NullString()
                    }
                    );
                if (base.m_ResultDB.ReturnInt == 0)
                {
        ...
        {
            POP.POP_SETTING008_1 popup = new POP.POP_SETTING008_1(dt_factory, dt_location);
            popup.ShowDialog();
            this.SearchPage();
        }
        ...
        private void btnCopy_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SETTING008.COPY_ITEM"
                    , new string[] { "A_PLANT","A_DEPARTMENT", "A_TRAN_USER", "A_LANG",

...
namespace Wisol.MES.Forms.SETTING.POP
{
    public partial class POP_SETTING006_2 : FormType
    {
        ...
        public POP_SETTING006_2(string device_id, string code, string device_name, string maintenance_id, string maintenance_name, string maintenance_days, string maintenance_hours) : this()
        {

...
{
    public partial class POP_SETTING008_1 : FormType
    {
        ...
        public POP_SETTING008_1(DataTable factory, DataTable location)
        {
            InitializeComponent();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                base.mResultDB = base.mDBaccess.ExcuteProc("PKG_SETTING008.POP_PUT_DEVICE"
                    , new string[] { "A_PLANT" ,
                        "A_DEPARTMENT",
                        "A_TRAN_USER",
                        "A_LANG",

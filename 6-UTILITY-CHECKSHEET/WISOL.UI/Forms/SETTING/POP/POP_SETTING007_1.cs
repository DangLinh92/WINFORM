...
{
    public partial class POP_SETTING007_1 : FormType
    {
        public string luongchuanhap { get; set; }
        public string soluongwafer { get; set; }

        public POP_SETTING007_1()
        {
            InitializeComponent();
            //this.layoutControlItem3.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never;
        }

        public POP_SETTING007_1(string device_id, string code, string device_name, string id_check, string name, string min, string max, string other) : this()
        {

...
{
    public partial class POP_SETTING005_3 : FormType
    {
        ...
        public POP_SETTING005_3(DataTable factory, DataTable location)
        {
            InitializeComponent();
        ...
        //public POP_SETTING005_3(DataTable location)
        //{
        //    InitializeComponent();
        //}
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                base.mResultDB = base.mDBaccess.ExcuteProc("PKG_SETTING005.POP_PUT_DEVICE"
                    , new string[] { "A_PLANT" ,
                        "A_DEPARTMENT",
                        "A_TRAN_USER",
                        "A_LANG",

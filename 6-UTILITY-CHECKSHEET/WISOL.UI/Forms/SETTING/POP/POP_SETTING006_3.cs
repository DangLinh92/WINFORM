...
{
    public partial class POP_SETTING006_3 : FormType
    {
        ...
        public POP_SETTING006_3(DataTable factory, DataTable location)
        {
            InitializeComponent();
        ...
        //public POP_SETTING006_3(DataTable location)
        //{
        //    InitializeComponent();
        //}
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                base.mResultDB = base.mDBaccess.ExcuteProc("PKG_SETTING006.POP_PUT_DEVICE"
                    , new string[] { "A_PLANT" ,
                        "A_DEPARTMENT",
                        "A_TRAN_USER",
                        "A_LANG",

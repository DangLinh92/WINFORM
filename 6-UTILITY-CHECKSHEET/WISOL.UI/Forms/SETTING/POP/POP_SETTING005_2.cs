...
{
    public partial class POP_SETTING005_2 : FormType
    {
        public string luongchuanhap { get; set; }
        public string soluongwafer { get; set; }

        public POP_SETTING005_2()
        {
            InitializeComponent();
            //this.layoutControlItem3.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never;
        }

        public POP_SETTING005_2(string device_id, string code, string device_name, string maintenance_id, string maintenance_name, string maintenance_days, string maintenance_hours) : this()
        {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if(string.IsNullOrEmpty(txtMaintenanceDays.Text.Trim()) && string.IsNullOrEmpty(txtMaintenanceHours.Text.Trim()))
                {
                    MsgBox.Show("MSG_ERR_058".Translation(), MsgType.Warning);
                    return;
                }
                if (!string.IsNullOrEmpty(txtMaintenanceDays.Text.Trim()) && !string.IsNullOrEmpty(txtMaintenanceHours.Text.Trim()))
                {

...
{
    public partial class SETTING010 : PageType
    {
        ...
        public override void SearchPage()
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SETTING010.GET_LIST"
                ...
                if (base.m_ResultDB.ReturnInt == 0)
                {
                    ...
                    DataTable bophans = base.m_ResultDB.ReturnDataSet.Tables[3].Copy();
                    base.m_BindData.BindGridLookEdit(stlBoPhan, bophans, "DEPARTMENT_NAME", "DEPARTMENT_NAME");
            ...
            try
            {
                ...
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SETTING010.PUT_SAVE"
                    ...
                    , new string[] { Consts.PLANT, "", Consts.USER_INFO.Id, Consts.USER_INFO.Language,
                        ...
                        txtModel.EditValue.NullString(),
                        txtSerial.EditValue.NullString(),
                        txtCongSuat.EditValue.NullString(),
                        txtDienAp.EditValue.NullString(),
        ...
        {
            base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SETTING010.GET_ITEM"
            ...
            if (base.m_ResultDB.ReturnInt == 0)
            {
                DataTable tableDevIfo = base.m_ResultDB.ReturnDataSet.Tables[0];
                txtDeviceID.Text = tableDevIfo.Rows[0]["DEVICE_ID"].ToString();
                txtCode.Text = tableDevIfo.Rows[0]["CODE"].ToString();
                txtDeviceName.Text = tableDevIfo.Rows[0]["DEVICE_NAME"].ToString();
                ...
                txtCongSuat.EditValue = tableDevIfo.Rows[0]["CongSuat"].ToString();
                txtDienAp.EditValue = tableDevIfo.Rows[0]["DienAp"].ToString();
                ...
                if (!txtCode.Text.Contains("_COPY"))
                {
        ...
        {
            POP.POP_SETTING010_1 popup = new POP.POP_SETTING010_1(dt_factory, dt_location);
            popup.ShowDialog();
            this.SearchPage();
        }
        ...
        private void btnDeleteDevice_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.OK)
            {
                try
                {
                    base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SETTING010.DELETE_DEVICE"
                        , new string[] { "A_PLANT", "A_DEPARTMENT", "A_TRAN_USER", "A_LANG", "A_CODE"
                        }
        ...
        private void btnCopy_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SETTING010.COPY_ITEM"
                    , new string[] { "A_PLANT","A_DEPARTMENT", "A_TRAN_USER", "A_LANG",
                                     "A_DEVICE_ID", "A_DEVICE_NAME", "A_LOCATION_ID", "A_TIME_SETUP","A_DEVICE_CODE",
                                     "A_MODEL","A_SERIAL","A_CONGSUAT","A_DIENAP","A_SLUONG_ACQUY","A_DUNGLUONG_ACQUY","A_CHUASUDUNG"}

                    , new string[] { Consts.PLANT, "", Consts.USER_INFO.Id, Consts.USER_INFO.Language,
                                     txtDeviceID.Text, txtDeviceName.Text.Trim(), gleLocation.EditValue.ToString(),
                                     dtpTimeSetup.Text.NullString(),txtCode.EditValue.NullString(),
                                     txtModel.Text.NullString(),txtSerial.Text.NullString(),
                                     txtCongSuat.Text.NullString(),txtDienAp.Text.NullString(),txtSoLuongAcquy.Text.NullString(),txtDungLuongAcquy.Text.NullString(),sudung}
                    );
                if (base.m_ResultDB.ReturnInt == 0)
                {
                    DataTable tableDevIfo = base.m_ResultDB.ReturnDataSet.Tables[0];

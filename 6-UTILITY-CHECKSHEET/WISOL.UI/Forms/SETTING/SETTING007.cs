    ...
    public partial class SETTING007 : PageType
    {
        ...
        public override void SearchPage()
        {
            ...
            try
            {
                ...
                if (base.m_ResultDB.ReturnInt == 0)
                {
                    ...
                    base.m_BindData.BindGridLookEdit(gleDepartment, dt_factory, "ID", "DEPARTMENT_NAME");
                    ...
                    //gvList.Columns["CODE"].Visible = false;
        ...
        private void Init_Control(bool condFlag)
        {
            try
            {
                ...
                gleDepartment.EditValue = string.Empty;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MsgBox.Show("Hãy nhập Department.\r\nPlease enter Department", MsgType.Warning);
                return;
            }
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SETTING007.PUT_SAVE"
                    , new string[] { "A_PLANT","A_DEPARTMENT", "A_TRAN_USER", "A_LANG",
        ...
        {
            base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SETTING007.GET_ITEM"
            ...
            if (base.m_ResultDB.ReturnInt == 0)
            {
                ...
                gleDepartment.EditValue = base.m_ResultDB.ReturnDataSet.Tables[0].Rows[0]["DEPARTMENT_ID"].ToString();
        ...
        private void btnEditItemCheck_Click(object sender, EventArgs e)
        {
            ...
            //POP.POP_SETTING007_1 popup = new POP.POP_SETTING007_1(device_id, code, device_name, id_check, name, min, max, other);
            //popup.ShowDialog();
        ...
        private void btnDeleteItemCheck_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.OK)
            {
                try
                {
                    base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SETTING007.DELETE_ITEM_CHECK"
        ...
        {
            POP.POP_SETTING007_3 popup = new POP.POP_SETTING007_3(dt_factory, dt_location);
            popup.ShowDialog();
            this.SearchPage();
        }
        ...
        private void btnDeleteDevice_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.OK)
            {
                try
                {
                    base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SETTING007.DELETE_DEVICE"
                        , new string[] { "A_PLANT", "A_DEPARTMENT", "A_TRAN_USER", "A_LANG", "A_CODE"
                        }
        ...
        {
            //DataTable dt_F;
            //string factoryID = gleDepartment.EditValue.ToString();

...
namespace Wisol.MES.Forms.REPORT
{
    public partial class REPORT008 : PageType
    {
        ...
        public override void InitializePage()
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_REPORT008.INT_LIST"
        ...
        private void gvList_RowClick(object sender, RowClickEventArgs e)
        {
            if (e.RowHandle >= 0)
            {
                ...
                try
                {
                    base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_REPORT008.GET_LIST_DETAIL"
                    , new string[] { "A_PLANT", "A_DEPARTMENT", "A_TRAN_USER", "A_LANG",
        ...
        private void imageSlider1_Click(object sender, EventArgs e)
        {
            ...
            {
                POP.POP_REPORT008 popup = new POP.POP_REPORT008(dt_url);
                popup.ShowDialog();
            }
        }

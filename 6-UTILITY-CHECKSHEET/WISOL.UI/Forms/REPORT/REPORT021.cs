...
{
    public partial class REPORT021 : PageType
    {
        ...
        public override void InitializePage()
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_REPORT021.INT_LIST"
        ...
        public override void SearchPage()
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_REPORT021.GET_LIST"
                , new string[] { "A_PLANT", "A_DEPARTMENT", "A_TRAN_USER", "A_LANG", 
        ...
        private void gvList_RowClick(object sender, RowClickEventArgs e)
        {
            if (e.RowHandle >= 0)
            {
                ...
                try
                {
                    base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_REPORT021.GET_LIST_DETAIL"
                    , new string[] { "A_PLANT", "A_DEPARTMENT", "A_TRAN_USER", "A_LANG",

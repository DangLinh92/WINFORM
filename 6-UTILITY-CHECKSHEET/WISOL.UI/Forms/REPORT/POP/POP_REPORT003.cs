...
namespace Wisol.MES.Forms.REPORT.POP
{
    public partial class POP_REPORT003 : FormType
    {
        ...
        public POP_REPORT003(string code, string name, string item, string chiphi,  string note, string _incidentID, string time_check)
        {
            ...
            txtItem.Text = item;
            if (!string.IsNullOrWhiteSpace(chiphi))
            {
                txtChiPhi.Text = chiphi;
            }
            memoNote.Text = note;
            ...
            try
            {
                ...
                {
                    base.mBindData.BindGridLookEdit(gleVatTu, base.mResultDB.ReturnDataSet.Tables[1], "CODE", "TEN_VAT_TU");
                    gleVatTu.EditValue = base.mResultDB.ReturnDataSet.Tables[2].Rows[0]["CODE"].ToString();
                    txtSoLuong.EditValue = base.mResultDB.ReturnDataSet.Tables[2].Rows[0]["SO_LUONG_VAT_TU"].ToString();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //string v_chi_phi = "";
                //if (!string.IsNullOrWhiteSpace(txtChiPhi.Text.Trim()))
                //{
                //    v_chi_phi = new string(txtChiPhi.Text.Trim().Where(c => char.IsDigit(c)).ToArray());
                //}
                ...
                base.mResultDB = base.mDBaccess.ExcuteProc("PKG_REPORT003.POP_SAVE"
                    ...
                    , new string[] { Consts.PLANT ,
                        ...
                        month.ToString(),
                        day.ToString(),
                        gleVatTu.EditValue.ToString(),
                        txtSoLuong.EditValue.ToString()
                    }
                    ); ;
                if (base.mResultDB.ReturnInt == 0)
                {

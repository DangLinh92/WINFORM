    ...
    public partial class POP_REPORT003_NEW : FormType
    {
        ...
        public POP_REPORT003_NEW(string input)
        {
            ...
            try
            {
                ...
                if (base.mResultDB.ReturnInt == 0)
                {
                    ...
                    base.mBindData.BindGridLookEdit(gleVatTu, base.mResultDB.ReturnDataSet.Tables[2], "CODE", "TEN_VAT_TU");
                }
                else
                {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string vat_tu = gleVatTu.EditValue.ToString();
                if (string.IsNullOrWhiteSpace(vat_tu))
                {
                    vat_tu = "NOTHING";
                }

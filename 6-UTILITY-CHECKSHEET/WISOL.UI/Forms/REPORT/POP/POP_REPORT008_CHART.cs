...
{
    public partial class POP_REPORT008_CHART : FormType
    {
        public POP_REPORT008_CHART(string dv_id, string c_code, string c_name, string c_item_name, string previous_date, string current_date)
        {
            InitializeComponent();

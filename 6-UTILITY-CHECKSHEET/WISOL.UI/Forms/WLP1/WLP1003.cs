...
{
    public partial class WLP1003 : PageType
    {
        public WLP1003()
        {
            InitializeComponent();
        ...
        public override void InitializePage()
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_WLP1003.INT_LIST"
                    , new string[] { "A_PLANT"
                    }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_WLP1003.PUT_ITEM"
                    , new string[] {
                        "A_LOT_NO","A_TRAN_USER"
                    }
                    , new string[] {

...
namespace Wisol.MES
{
    class Settings
    {
        ...
        public static void SettingCreate()
        {
            ...
            dtSetting.Rows.Add(new object[] { "USERINFO", "USER_LANGUAGE", "KOR" });
        ...
        public static void SettingRead()
        {
            ...
            if (Consts.ACCESS_MSG.Replace("AUTO_UPDATE_", "") == "OUT")
            {
                ...
                if (Consts.UPDATE_IP == "211.105.218.140")
                {
                    Consts.ACCESS_PLANT = "KR12";
                    Consts.PLANT = "KR12";
                }
                if (Consts.UPDATE_IP == "121.152.71.146")
                {
                    Consts.ACCESS_PLANT = "KR11";
                    Consts.PLANT = "KR11";
                }
                if (Consts.UPDATE_IP == "113.160.155.140")
                {
                    Consts.ACCESS_PLANT = "VN11";
                    Consts.PLANT = "VN11";
                }
        ...
        public static void SaveUser()
        {
            try
            {
                ...
                dtSetting.Rows.Add(new object[] { "USER", "USER_ID", Consts.USER_INFO.Id });
        ...
        public static void LoadUser()
        {
            ...
            for (int i = 0; i < drService.Length; i++)
            {
                ...
                switch (drService[i]["KEY"].NullString())
                {
                    case "USER_ID": Consts.USER_INFO.Id = value; break;
                }
            }
        }

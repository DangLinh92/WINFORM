...
namespace Wisol.MES.Forms.WLP1
{
    public partial class WLP1001 : PageType
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //string loc = rdgLocation.EditValue.ToString();
            //if (rdgLocation.EditValue.ToString().ToUpper() != "INSIDE" || rdgLocation.EditValue.ToString().ToUpper() != "OUTSIDE")
            //{
            //    MsgBox.Show("HÃY CHỌN VỊ TRÍ KHO".Translation(), MsgType.Warning);
            //    return;
            //}
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_WLP1001.PUT_ITEM_NEW"
                    , new string[] {
                        "A_CODE",
                        "A_QUANTITY",
                        "A_MAKE_DATE",

...
{
    public partial class WLP1005 : PageType
    {
        public WLP1005()
        {
            InitializeComponent();
        ...
        public override void InitializePage()
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_WLP1005.INT_LIST"
                    , new string[] { "A_PLANT"
                    }
        ...
        public override void SearchPage()
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_WLP1005.GET_LIST_NEW"
                , new string[] { "A_PLANT", "A_LANG", "A_LOCATION"},
                  new string[] { Consts.PLANT, Consts.USER_INFO.Language, rdgLocation.EditValue.ToString() }
                );
                if (base.m_ResultDB.ReturnInt == 0)
                {
                    base.m_BindData.BindGridView(gcList,
                ...
                gvList.Columns["STOCK"].AppearanceCell.TextOptions.HAlignment = HorzAlignment.Far;
                gvList.Columns["STOCK"].Width = 110;
        ...
        private void gvList_RowClick(object sender, RowClickEventArgs e)
        {
            if(e.RowHandle >= 0)
            {
                ...
                try
                {
                    base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_WLP1005.GET_LIST_DETAIL_NEW"
                    , new string[] { "A_CODE", "A_LOCATION" },
                      new string[] { code, rdgLocation.EditValue.NullString() }
                    );
                    if (base.m_ResultDB.ReturnInt == 0)
                    {
                        base.m_BindData.BindGridView(gcList2,
        ...
        private void rdgLocation_SelectedIndexChanged(object sender, EventArgs e)
        {
            this.SearchPage();
        }
    }

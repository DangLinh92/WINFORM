...
namespace Wisol.DataAcess
{
    public class DBAccess
    {
        ...
        private string connectionString = "Data Source = 10.70.10.97;Initial Catalog = LOT_HISTORY_DB;User Id = sa;Password = Wisol@123;Connect Timeout=3";
        private string connectionString1 = "Persist Security Info=True;User ID=whcspadmin;Password=mesadmin;Initial Catalog=MESDB;Data Source=10.70.21.214;";
        ...
        public ResultDB SqlExecuteDataTable(string sqlQry)
        {
            try
            {
                string connection = connectionString;

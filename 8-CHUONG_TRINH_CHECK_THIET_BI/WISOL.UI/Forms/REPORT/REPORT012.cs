...
{
    public partial class REPORT012 : PageType
    {
        public REPORT012()
        {
            InitializeComponent();
        ...
        public override void InitializePage()
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_REPORT012.INT_LIST"
                    , new string[] { "A_PLANT"
                    }
        ...
        public override void SearchPage()
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_REPORT012.TREND_LINE"
                    , new string[] { "A_DAYS" }
                ...
                if (base.m_ResultDB.ReturnInt == 0)
                {
                    ...
                    //table1.Columns.Add("Maintenance_Date", typeof(System.DateTime));
                    ...
                    foreach (DataRow row in table1.Rows)
                    {
                        ...
                        for (int i = 2; i < row.ItemArray.Length - 3; i++)
                        {
        ...
        {
            //table.Columns["Maintenance_Date"].SetOrdinal(2);
            table.Columns["Pickup_Count"].SetOrdinal(3);
            int columnIndex = 3; 
        ...
        {
            if(e.Column.FieldName != "Line" && e.Column.FieldName != "Machine_Name" && e.Column.FieldName != "Day over target"
                && e.Column.FieldName != "Maintenance_Date" && e.Column.FieldName != "Pickup_Count")
            {
                double target = Double.Parse(txtTarget.EditValue.ToString());
            ...
            //if (e.Column.FieldName == "Day over target")
            //{
            //    string cellValue = gvList.GetRowCellDisplayText(e.RowHandle, e.Column);
            //    if (!string.IsNullOrWhiteSpace(cellValue))
            //    {

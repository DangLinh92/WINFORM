...
namespace Wisol.MES.Forms.REPORT
{
    public partial class REPORT003 : PageType
    {
        ...
        public override void Form_Show()
        {
            base.Form_Show();
            this.InitializePage();
            dtpFrom.EditValue = DateTime.Now.AddDays(-30).ToString("yyyy-MM-dd"); //DateTime.Now.AddYears(-3).ToString("yyyy-MM-dd");
        ...
        public override void SearchPage()
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_REPORT003.GET_LIST"
                    ...
                    , new string[] { Consts.PLANT, Consts.DEPARTMENT, Consts.USER_INFO.Id, Consts.USER_INFO.Language, dtpFrom.DateTime.ToString("yyyy-MM-dd"), dtpTo.DateTime.ToString("yyyy-MM-dd")
                    }
                    );
                if (base.m_ResultDB.ReturnInt == 0)
                {

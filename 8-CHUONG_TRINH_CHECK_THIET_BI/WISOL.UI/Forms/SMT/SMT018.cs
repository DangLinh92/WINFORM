...
{
    public partial class SMT018 : PageType
    {
        public SMT018()
        {
            InitializeComponent();
        ...
        public override void InitializePage()
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SMT018.INT_LIST"
                    , new string[] { "A_PLANT"
                    }
        ...
        {
            if(txtPackingUnit.Text.Trim() == string.Empty)
            {
                return;
            }
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SMT018.GET_LIST"
                , new string[] { "A_PACKING_UNIT"},
                  new string[] { txtPackingUnit.Text.Trim() }
                );
                if (base.m_ResultDB.ReturnInt == 0)
                {
                    base.m_BindData.BindGridView(gcList,

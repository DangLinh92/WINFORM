...
namespace Wisol.MES.Forms.SETTING
{
    public partial class SETTING004 : PageType
    {
        ...
        public override void Form_Show()
        {
            ...
            numericUpDown1.Value = Consts.X_POINT;
            this.labelControl1.Text = "  NOTE\r\n  0: không dịch chuyển \r\n  Âm: dịch sang trái\r\n  Dương: dịch sang phải\r\n  Dịch chuyển tương ứng với giá trị nhập vào";
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            UserClass.PrintLabel print = new UserClass.PrintLabel(base.m_DBaccess);
            print.PrintUTI((int)numericUpDown1.Value, 0, txtLotNo.Text.Trim());
            txtLotNo.Text = "";
        }

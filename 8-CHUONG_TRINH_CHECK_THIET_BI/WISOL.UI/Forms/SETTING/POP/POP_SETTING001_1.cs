...
namespace Wisol.MES.Forms.SETTING.POP
{
    public partial class POP_SETTING001_1 : FormType
    {
        ...
        public POP_SETTING001_1(string device_id, string code, string device_name, string id_check, string name, string min, string max, string other, string don_vi_tinh) : this()
        {
            ...
            this.txtDonViTinh.Text = don_vi_tinh;

    ...
    public partial class SETTING001 : PageType
    {
        ...
        private void GetItemDetail(string ID)
        {
            base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SETTING001.GET_ITEM"
                    ...
                    , new string[] { Consts.PLANT, Consts.DEPARTMENT, Consts.USER_INFO.Id, Consts.USER_INFO.Language, ID
                    }
                    );
            if (base.m_ResultDB.ReturnInt == 0)
            {
        ...
        private void btnEditItemCheck_Click(object sender, EventArgs e)
        {
            ...
            string don_vi_tinh = dr_item_check[0].ItemArray[8].ToString();
            ...
            if (dialogResult == DialogResult.OK)
            {
                try
                {
                    base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SETTING001.DELETE_ITEM_CHECK"
                        ...
                        , new string[] { Consts.PLANT, Consts.DEPARTMENT, Consts.USER_INFO.Id, Consts.USER_INFO.Language, item_check_id
                        }
                        );
                    if (base.m_ResultDB.ReturnInt == 0)
                    {
        ...
        private void btnEditMaintenance_Click(object sender, EventArgs e)
        {
            ...
            POP.POP_SETTING001_2 popup = new POP.POP_SETTING001_2(device_id, code, device_name, maintenance_id, maintenance_name, maintenance_days);
            popup.ShowDialog();
            GetItemDetail(txtDeviceID.Text);
        }

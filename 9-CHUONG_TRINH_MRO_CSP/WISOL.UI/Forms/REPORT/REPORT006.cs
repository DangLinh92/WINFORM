...
namespace Wisol.MES.Forms.REPORT
{
    public partial class REPORT006 : PageType
    {
        ...
        public override void InitializePage()
        {
            ...
            worksheet.Cells["A4"].Value = "C-CHIP";
            worksheet.Cells["A5"].Value = "CSP";
            worksheet.Cells["A6"].Value = "DPX";
            worksheet.Cells["A7"].Value = "IND";
            worksheet.Cells["A8"].Value = "LNA";
            worksheet.Cells["A9"].Value = "LPF";
            worksheet.Cells["A10"].Value = "SW";
            worksheet.Cells["A11"].Value = "WLP";
            ...
            worksheet.MergeCells(worksheet.Range["A12:AL12"]);
            worksheet.Cells["A12"].Value = "Loss per Unit = Total Loss(VND)/Finished product(ea)";
            worksheet.Cells["A12"].Font.Size = 9;
            worksheet.Cells["A12"].Font.Italic = true;
            worksheet.Cells["A12"].Font.Color = Color.Blue;
            worksheet.Cells["A12"].Alignment.Horizontal = SpreadsheetHorizontalAlignment.Left;
        ...
        private void C1()
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                ninethRow[i * 6 + 4].Fill.BackgroundColor = Color.White;
                ninethRow[i * 6 + 4].Font.Color = Color.Blue;
            }

            worksheet.Range["B3:B11"].Value = txtTarget.EditValue.ToString();
            if (results.Rows.Count > 0)
            {
                for (int i = 0; i <= count; i++)
                {
                    ...
                    for (int j = 0; j < results.Rows.Count; j++)
                    {
                        ...
                        {
                            if (results.Rows[j]["Type"].ToString().Trim() == "Total")
                            {
                                ...
                                firstRow[i * 6 + 4].Value = (results.Rows[j][4].ToString() == "NaN" ? "0" : results.Rows[j][4].ToString());
                            ...
                            if (results.Rows[j]["Type"].ToString().Trim().ToUpper() == "C-CHIP")
                            {
                                ...
                                secondRow[i * 6 + 4].Value = (results.Rows[j][4].ToString() == "NaN" ? "0" : results.Rows[j][4].ToString());
                                if (string.Compare(results.Rows[j][4].ToString(), txtTarget.EditValue.ToString()) > 0)
                                {
                            ...
                            if (results.Rows[j]["Type"].ToString().Trim().ToUpper() == "CSP")
                            {
                                ...
                                thirdRow[i * 6 + 4].Value = (results.Rows[j][4].ToString() == "NaN" ? "0" : results.Rows[j][4].ToString());
                                if (string.Compare(results.Rows[j][4].ToString(), txtTarget.EditValue.ToString()) > 0)
                                {
                            ...
                            if (results.Rows[j]["Type"].ToString().Trim().ToUpper() == "DPX")
                            {
                                ...
                                fourthRow[i * 6 + 4].Value = (results.Rows[j][4].ToString() == "NaN" ? "0" : results.Rows[j][4].ToString());
                                if (string.Compare(results.Rows[j][4].ToString(), txtTarget.EditValue.ToString()) > 0)
                                {
                            ...
                            if (results.Rows[j]["Type"].ToString().Trim().ToUpper() == "IND")
                            {
                                ...
                                fifthRow[i * 6 + 4].Value = (results.Rows[j][4].ToString() == "NaN" ? "0" : results.Rows[j][4].ToString());
                                if (string.Compare(results.Rows[j][4].ToString(), txtTarget.EditValue.ToString()) > 0)
                                {
                            ...
                            if (results.Rows[j]["Type"].ToString().Trim().ToUpper() == "LNA")
                            {
                                ...
                                sixthRow[i * 6 + 4].Value = (results.Rows[j][4].ToString() == "NaN" ? "0" : results.Rows[j][4].ToString());
                                if (string.Compare(results.Rows[j][4].ToString(), txtTarget.EditValue.ToString()) > 0)
                                {
                            ...
                            if (results.Rows[j]["Type"].ToString().Trim().ToUpper() == "LPF")
                            {
                                ...
                                seventhRow[i * 6 + 4].Value = (results.Rows[j][4].ToString() == "NaN" ? "0" : results.Rows[j][4].ToString());
                                if (string.Compare(results.Rows[j][4].ToString(), txtTarget.EditValue.ToString()) > 0)
                                {
                            ...
                            if (results.Rows[j]["Type"].ToString().Trim().ToUpper() == "SW")
                            {
                                ...
                                eighthRow[i * 6 + 4].Value = (results.Rows[j][4].ToString() == "NaN" ? "0" : results.Rows[j][4].ToString());
                                if (string.Compare(results.Rows[j][4].ToString(), txtTarget.EditValue.ToString()) > 0)
                                {
                            ...
                            if (results.Rows[j]["Type"].ToString().Trim().ToUpper() == "WLP")
                            {
                                ninethRow[i * 6 + 2].Value = String.Format("{0:#,##0}", results.Rows[j][2].ToInt());
                                ninethRow[i * 6 + 3].Value = String.Format("{0:#,##0}", results.Rows[j][3].ToInt());
                                ninethRow[i * 6 + 4].Value = (results.Rows[j][4].ToString() == "NaN" ? "0" : results.Rows[j][4].ToString());
                                if (string.Compare(results.Rows[j][4].ToString(), txtTarget.EditValue.ToString()) > 0)
                                {
                                    ninethRow[i * 6 + 4].Fill.BackgroundColor = Color.FromArgb(255, 199, 206);
                                    ninethRow[i * 6 + 4].Font.Color = Color.FromArgb(156, 0, 6);
                                }
                                ninethRow[i * 6 + 5].Value = String.Format("{0:#,##0}", results.Rows[j][5].ToInt());
                                ninethRow[i * 6 + 6].Value = String.Format("{0:#,##0}", results.Rows[j][6].ToInt());
                                ninethRow[i * 6 + 7].Value = results.Rows[j][7].ToString();
                            }
                        }
                    }
                }
        ...
        private DataTable CreateChartData(int intYear, int intMonthFrom, int intMonthTo)
        {
            ...
            for (int c = intMonthFrom; c <= intMonthTo; c++)
            {
                ...
                //        strSqlString.AppendFormat("T1.Type as Type, SUM(T1.TOTAL_PICKUP) as Total_Pickup, SUM(T1.TOTAL_LOSS) as Total_Loss, cast(round(SUM(TOTAL_VND),0) as int) as 'Amount(VND)' \n");
                //        strSqlString.AppendFormat("FROM \n");
                //        strSqlString.AppendFormat("( select pri.Type, xx.Total_Pickup, xx.Total_Loss, xx.Total_Loss*pri.Price as Total_VND from \n");
                ...
                //        //strSqlString.AppendFormat("EWIPSMTPRI.PRICE*(sum(compdetail.sRejectIdent) + sum(compdetail.sRejectVacuum) + sum(compdetail.sTrackEmpty)) as Total_VND \n");
                //        strSqlString.AppendFormat("FROM \n");
                ...
                //        strSqlString.AppendFormat("dttime >= '{0}' + ' 08:00:00.000' and dttime <= '{1}' + ' 08:00:00.000' \n", firstDayOfMonth.ToString("yyyy-MM-dd"), firstDayOfMonth.AddMonths(1).ToString("yyyy-MM-dd")); // and EWIPSMTPRI.YEAR = '{2}' and EWIPSMTPRI.MONTH = '{3}' \n", StartDate.AddDays(i).ToString("yyyy-MM-dd"), StartDate.AddDays(i + 1).ToString("yyyy-MM-dd"), StartDate.AddDays(i).Year.ToString(), month);
                //        //strSqlString.AppendFormat("and EWIPSMTPRI.TYPE in ('LNA','CSP','SW','WLP') \n");
                //        strSqlString.AppendFormat("group by  PARTNUMBER.strPartNumber \n");
                //        strSqlString.AppendFormat(") xx inner join EWIPSMTPRI pri on pri.COMMCODE = xx.PartNumber collate SQL_Latin1_General_CP1_CI_AS \n");
                //        strSqlString.AppendFormat(" where pri.YEAR = '{0}' and pri.MONTH = '{1}' \n", intYear.ToString(), month);
                //        strSqlString.AppendFormat(" and  pri.TYPE in ('LNA','CSP','SW','WLP') \n");
                //        strSqlString.AppendFormat(") T1 \n");
                //        strSqlString.AppendFormat("GROUP BY T1.Type");

                //        new SqlDataAdapter(strSqlString.ToString(), conn).Fill(tb);

                //        StringBuilder strSqlString2 = new StringBuilder();

                //        strSqlString2.AppendFormat("select  sum(t1.finish) as Finish \n");
                //        strSqlString2.AppendFormat("from \n");
                //        strSqlString2.AppendFormat("( select xx.Finish/cri.criteria as Finish from \n");
                //        strSqlString2.AppendFormat("( SELECT \n");
                //        strSqlString2.AppendFormat("  sum(compDetail.sAccessTotal) - (sum(compdetail.sRejectIdent) + sum(compdetail.sRejectVacuum) + sum(compdetail.sTrackEmpty)) as Finish, \n");
                //        strSqlString2.AppendFormat(" right(PARTNUMBER.strPartNumber, charindex('\\', reverse(PARTNUMBER.strPartNumber)) - 1) as partnumber \n");
                //        strSqlString2.AppendFormat("FROM \n");
                //        strSqlString2.AppendFormat("[PCCLIENT" + j + "].SiplaceOIS.dbo.compBlock \n");
                //        strSqlString2.AppendFormat("inner join \n");
                //        strSqlString2.AppendFormat("    [PCCLIENT" + j + "].SiplaceOIS.dbo.compdetail \n");
                //        strSqlString2.AppendFormat("    on compBlock.lIdBlock = compDetail.lIdBlock \n");
                //        strSqlString2.AppendFormat("inner join \n");
                //        strSqlString2.AppendFormat("    [PCCLIENT" + j + "].SiplaceOIS.dbo.compPosition \n");
                //        strSqlString2.AppendFormat("    on compDetail.lIdPosition = compPosition.lIdPosition \n");
                //        strSqlString2.AppendFormat("inner join \n");
                //        strSqlString2.AppendFormat("    [PCCLIENT" + j + "].SiplaceOIS.dbo.PARTNUMBER \n");
                //        strSqlString2.AppendFormat("    on PARTNUMBER.lPartNumber = Compposition.lPartNumber \n");
                //        //strSqlString2.AppendFormat("inner join \n");
                //        //strSqlString2.AppendFormat("    EWIPSMTCRI cri \n");
                //        //strSqlString2.AppendFormat("    on right(PARTNUMBER.strPartNumber, charindex('\\', reverse(PARTNUMBER.strPartNumber)) - 1) = cri.COMMCODE collate SQL_Latin1_General_CP1_CI_AS \n");
                //        strSqlString2.AppendFormat(" \n");
                //        strSqlString2.AppendFormat("WHERE \n");
                //        strSqlString2.AppendFormat("dttime >= '{0}' + ' 08:00:00.000' and dttime <= '{1}' + ' 08:00:00.000' \n", firstDayOfMonth.ToString("yyyy-MM-dd"), firstDayOfMonth.AddMonths(1).ToString("yyyy-MM-dd"));
                //        strSqlString2.AppendFormat("group by \n");
                //        strSqlString2.AppendFormat(" PARTNUMBER.strPartNumber \n");
                //        strSqlString2.AppendFormat(" ) xx inner join  EWIPSMTCRI cri  on xx.partnumber = cri.COMMCODE collate SQL_Latin1_General_CP1_CI_AS \n");
                //        strSqlString2.AppendFormat(") t1");

                //        new SqlDataAdapter(strSqlString2.ToString(), conn).Fill(tb2);
                //    }
                //}
                //}
                ...
                try
                {
                    base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_REPORT006.GET_LIST_1"
                ...
                try
                {
                    base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_REPORT006.GET_LIST_2"
                        , new string[] { "A_FROM_DATE",
                                         "A_TO_DATE",
                                         "A_YEAR",
                                         "A_MONTH"
                    ...
                    if (base.m_ResultDB.ReturnInt == 0)
                    {
                        ...
                        tb2 = base.m_ResultDB.ReturnDataSet.Tables[0];
                    }
                }
                catch (Exception ex)
                {
                ...
                if (tb.Rows.Count > 0)
                {
                    ...
                    {
                        if (tb.Rows[z]["Type"].ToString().ToUpper() == "LNA")
                        {
                            lna_pickup += Convert.ToDouble(tb.Rows[z]["Total_Pickup"].ToString());
                            lna_loss += Convert.ToDouble(tb.Rows[z]["Total_Loss"].ToString());
                            lna_vnd += Convert.ToDouble(tb.Rows[z]["Amount(VND)"].ToString());
                        }

                        if (tb.Rows[z]["Type"].ToString().ToUpper() == "CSP")
                        {
                            csp_pickup += Convert.ToDouble(tb.Rows[z]["Total_Pickup"].ToString());
                            csp_loss += Convert.ToDouble(tb.Rows[z]["Total_Loss"].ToString());
                            csp_vnd += Convert.ToDouble(tb.Rows[z]["Amount(VND)"].ToString());
                        }

                        if (tb.Rows[z]["Type"].ToString().ToUpper() == "SW")
                        {
                            sw_pickup += Convert.ToDouble(tb.Rows[z]["Total_Pickup"].ToString());
                            sw_loss += Convert.ToDouble(tb.Rows[z]["Total_Loss"].ToString());
                            sw_vnd += Convert.ToDouble(tb.Rows[z]["Amount(VND)"].ToString());
                        }

                        if (tb.Rows[z]["Type"].ToString().ToUpper() == "WLP")
                        {
                            wlp_pickup += Convert.ToDouble(tb.Rows[z]["Total_Pickup"].ToString());
                            wlp_loss += Convert.ToDouble(tb.Rows[z]["Total_Loss"].ToString());
                            wlp_vnd += Convert.ToDouble(tb.Rows[z]["Amount(VND)"].ToString());
                        }

                        if (tb.Rows[z]["Type"].ToString().ToUpper() == "C-CHIP")
                        {
                            cchip_pickup += Convert.ToDouble(tb.Rows[z]["Total_Pickup"].ToString());
                            cchip_loss += Convert.ToDouble(tb.Rows[z]["Total_Loss"].ToString());
                            cchip_vnd += Convert.ToDouble(tb.Rows[z]["Amount(VND)"].ToString());
                        }

                        if (tb.Rows[z]["Type"].ToString().ToUpper() == "DPX")
                        {
                            dpx_pickup += Convert.ToDouble(tb.Rows[z]["Total_Pickup"].ToString());
                            dpx_loss += Convert.ToDouble(tb.Rows[z]["Total_Loss"].ToString());
                            dpx_vnd += Convert.ToDouble(tb.Rows[z]["Amount(VND)"].ToString());
                        }

                        if (tb.Rows[z]["Type"].ToString().ToUpper() == "IND")
                        {
                            ind_pickup += Convert.ToDouble(tb.Rows[z]["Total_Pickup"].ToString());
                            ind_loss += Convert.ToDouble(tb.Rows[z]["Total_Loss"].ToString());
                            ind_vnd += Convert.ToDouble(tb.Rows[z]["Amount(VND)"].ToString());
                        }

                        if (tb.Rows[z]["Type"].ToString().ToUpper() == "LPF")
                        {
                            lpf_pickup += Convert.ToDouble(tb.Rows[z]["Total_Pickup"].ToString());
                            lpf_loss += Convert.ToDouble(tb.Rows[z]["Total_Loss"].ToString());
                            lpf_vnd += Convert.ToDouble(tb.Rows[z]["Amount(VND)"].ToString());
                        }
                    }
                    //for (int z = 0; z < tb2.Rows.Count; z++)
                    //{
                    //    if (!string.IsNullOrWhiteSpace(tb2.Rows[z][0].ToString()))
                    //    {
                    //        finish += Convert.ToDouble(tb2.Rows[z][0].ToString());
                    //    }
                    //}

                    finish = Convert.ToDouble(tb2.Rows[0][0].ToString());

                    total_pickup = lna_pickup + csp_pickup + sw_pickup + wlp_pickup + cchip_pickup + dpx_pickup + ind_pickup + lpf_pickup;
                    total_loss = lna_loss + csp_loss + sw_loss + wlp_loss + cchip_loss + dpx_loss + ind_loss + lpf_loss;
                    total_vnd = lna_vnd + csp_vnd + sw_vnd + wlp_vnd + cchip_vnd + dpx_vnd + ind_vnd + lpf_vnd;

                    table.Rows.Add(new object[] { intYear + "." + month, "CSP", csp_pickup, csp_loss, Math.Round(csp_loss * 100 / csp_pickup, 2), csp_vnd, 0, Math.Round(csp_vnd / finish, 1) });
                    table.Rows.Add(new object[] { intYear + "." + month, "LNA", lna_pickup, lna_loss, Math.Round(lna_loss * 100 / lna_pickup, 2), lna_vnd, 0, Math.Round(lna_vnd / finish, 1) });
                    table.Rows.Add(new object[] { intYear + "." + month, "SW", sw_pickup, sw_loss, Math.Round(sw_loss * 100 / sw_pickup, 2), sw_vnd, 0, Math.Round(sw_vnd / finish, 1) });
                    table.Rows.Add(new object[] { intYear + "." + month, "WLP", wlp_pickup, wlp_loss, Math.Round(wlp_loss * 100 / wlp_pickup, 2), wlp_vnd, 0, Math.Round(wlp_vnd / finish, 1) });
                    table.Rows.Add(new object[] { intYear + "." + month, "C-CHIP", cchip_pickup, cchip_loss, Math.Round(cchip_loss * 100 / cchip_pickup, 2), cchip_vnd, 0, Math.Round(cchip_vnd / finish, 1) });
                    table.Rows.Add(new object[] { intYear + "." + month, "DPX", dpx_pickup, dpx_loss, Math.Round(dpx_loss * 100 / dpx_pickup, 2), dpx_vnd, 0, Math.Round(dpx_vnd / finish, 1) });
                    table.Rows.Add(new object[] { intYear + "." + month, "IND", ind_pickup, ind_loss, Math.Round(ind_loss * 100 / ind_pickup, 2), ind_vnd, 0, Math.Round(ind_vnd / finish, 1) });
                    table.Rows.Add(new object[] { intYear + "." + month, "LPF", lpf_pickup, lpf_loss, Math.Round(lpf_loss * 100 / lpf_pickup, 2), lpf_vnd, 0, Math.Round(lpf_vnd / finish, 1) });
                    table.Rows.Add(new object[] { intYear + "." + month, " Total", total_pickup, total_loss, Math.Round(total_loss * 100 / total_pickup, 2), total_vnd, finish, Math.Round(total_vnd / finish, 1) });
                }
            }
            return table;
        }
        ...
        private void btnExportToExcel_Click(object sender, EventArgs e)
        {
            using (var saveDialog = new SaveFileDialog())
            {
                ...
                saveDialog.FileName = "Pick Up Rate_By Month and Material_" + DateTime.Now.ToString("yyyyMMddHHmmss");
                if (saveDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    try
                    {
                        worksheet.Pictures.AddPicture(Application.StartupPath + @"\images1.png", worksheet.Cells["A10"]);
                        worksheet.Pictures.AddPicture(Application.StartupPath + @"\images2.png", worksheet.Cells["A27"]);
                    }
                    finally
                    {
                        workbook.EndUpdate();

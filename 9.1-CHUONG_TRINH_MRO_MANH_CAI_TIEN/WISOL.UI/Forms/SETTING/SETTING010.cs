...
namespace Wisol.MES.Forms.SETTING
{
    public partial class SETTING010 : PageType
    {
        ...
        public override void Form_Show()
        {
            ...
            // Manh them vao ****************************
            //txtOffetLeadTime.Properties.MaxValue = 4;
        ...
        public override void SearchPage()
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SETTING005.GET_LIST_TEMP_01"
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //    if (Consts.DEPARTMENT == "WLP1")// Bộ phận WLP1
            //    {

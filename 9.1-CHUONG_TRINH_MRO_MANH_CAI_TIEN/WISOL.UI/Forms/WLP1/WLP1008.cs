        ...
        private void btnXacNhan_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_WLP1008.GET_LIST_XacNhan",
                    new string[] { "A_PLANT", "A_LANG", "A_SO_LUONG_WAFER", "A_XML", "A_DEPARTMENT" },
                    new string[] { Consts.PLANT, Consts.USER_INFO.Language, count.ToString(), XML, Consts.DEPARTMENT }
                 );
                if (base.m_ResultDB.ReturnInt == 0)
                {
                    base.m_BindData.BindGridView(gcList,
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_WLP1008.PUT_ITEM"
                    , new string[] { "A_XML1", "A_XML2", "A_TRAN_USER", "A_DEPARTMENT"
                    }
                    , new string[] { XML1, XML2, Consts.USER_INFO.Id, Consts.DEPARTMENT
                    }
                    );
                if (base.m_ResultDB.ReturnInt == 0)
                {

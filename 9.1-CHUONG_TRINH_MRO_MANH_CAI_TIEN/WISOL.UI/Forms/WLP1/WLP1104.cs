...
{
    public partial class WLP1104 : PageType
    {
        public WLP1104()
        {
            InitializeComponent();
        ...
        public override void InitializePage()
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_WLP1104.INT_LIST"
        ...
        public override void SearchPage()
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_WLP1104.GET_LIST"
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_WLP1104.PUT_ITEM"
                    , new string[] {
                        "A_LOT_NO",
                        "A_TRAN_USER",
                        "A_DEPARTMENT"

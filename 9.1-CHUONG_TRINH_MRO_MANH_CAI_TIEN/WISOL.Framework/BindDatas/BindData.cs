...
namespace Wisol.BindDatas
{
    public class BindData
    {
        ...
        public void BindTreeList(TreeList tl, DataTable dataTable, bool repaint = false, string hidden = "")
        {
            try
            {
        ...
        //************* Manh them mot ham de kiem tr du lieu trong Grid control ********************************
        public void SetCellColor(GridControl gc, int vCondition) {
            var view = gc.MainView as GridView;
            for (int i = 0; i < view.RowCount - 1; i++) {
                string temp = view.GetRowCellValue(i, "CAN_USE_FOR").ToString();
                if ((temp != "")&&(temp != null) && (temp != " "))
                {
                    temp=temp.Substring(1, temp.Length - 1);
                    string[] vArray = temp.Split(' ');
                    if (Convert.ToInt32(vArray[0]) < vCondition) {
                        view.Appearance.Row.BackColor = Color.Pink;
                        
                    }
                }
                //view.RowCellStyle += (sender, e) => {
                //    GridView view1 = sender as GridView;
                //    bool _mark = (bool)view1.GetRowCellValue(e.RowHandle, "Mark");
            ...
            try
            {
                ...
                for (int i = 0; i < dataTable.Columns.Count; i++)
                {
                    ...
                    switch (dataColumn.DataType.NullString())
                    {
                        ...
                        case "System.Decimal":
                        case "System.Double":
                            //if (gridColumn.FieldName.Equals("QUANTITY") || gridColumn.FieldName.Equals("AMOUNT_USD") || gridColumn.FieldName.Equals("TOTAL_MONEY_USD"))
                            if (gridColumn.FieldName.Equals("TOTAL_MONEY_USD") || gridColumn.FieldName.Equals("AMOUNT_USD"))
                            {
                        ...
                        case "System.Byte":
                            if (gridColumn.DisplayFormat.FormatString == string.Empty)
                            {
                                // Manh sua doan nay de chi show tong nhung cot can thiet.
                                if (gridColumn.FieldName.Equals("TOTAL_PRICE")|| gridColumn.FieldName.Equals("TON_KHO")|| gridColumn.FieldName.Equals("LUONG_CHUA_NHAP")|| gridColumn.FieldName.Equals("LUONG_CAN_MUA")|| gridColumn.FieldName.Equals("TOTAL_MONEY_USD") || gridColumn.FieldName.Equals("AMOUNT") || gridColumn.FieldName.Equals(" QUANTITY ")) {
                                    gridColumn.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
                                    gridColumn.DisplayFormat.FormatString = "n2";
                                    gridColumn.SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Sum;
                                    gridColumn.SummaryItem.DisplayFormat = "SUM={0:n0}";
                            ...
                            break;
                        case "System.String": // Manh sua doan nay de chi show tong nhung cot can thiet.
                            if (gridColumn.FieldName.Equals("QUANTITY") || gridColumn.FieldName.Equals("TOTAL_MONEY_USD"))
                            {
                                gridColumn.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
                                gridColumn.DisplayFormat.FormatString = "n2";
                                gridColumn.SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Sum;
                            ...
                            break;
                        default:
                            if (gridColumn.FieldName.Equals("QUANTITY") || gridColumn.FieldName.Equals("TOTAL_MONEY_USD") || gridColumn.FieldName.Equals("SO_LUONG_DAT_HANG")|| gridColumn.FieldName.Equals("SO_LUONG_HIEN_TAI") || gridColumn.FieldName.Equals("SO_TIEN_DAT_HANG_usd")|| gridColumn.FieldName.Equals("SO_TIEN_HIEN_TAI_usd") || gridColumn.FieldName.Equals("AMOUNT_USD"))
                            {
                                gridColumn.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
                                gridColumn.DisplayFormat.FormatString = "n2";
                                gridColumn.SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Sum;

...
namespace Wisol.MES.Forms.SETTING
{
    public partial class SETTING002 : PageType
    {
        ...
        public override void Form_Show()
        {
            ...
            Classes.Common.SetFormIdToButton(this, "SETTING002");
        }
        ...
        private void Init_Control(bool condFlag)
        {
            try
            {
                ...
                txtInfo.EditValue = string.Empty;
            }
            catch (Exception ex)
            {
                MsgBox.Show(ex.Message, MsgType.Error);
        ...
        private void gvList_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    txtInfo.EditValue = gvList.GetDataRow(e.RowHandle)["INFO"].NullString();
                }
            }
            catch (Exception ex)
            {

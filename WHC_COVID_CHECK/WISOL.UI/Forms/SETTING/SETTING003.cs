    ...
    public partial class SETTING003 : PageType
    {
        ...
        private void Init_Control(bool condFlag)
        {
            try
            {
                ...
                txtVnName.EditValue = string.Empty;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(txtGLAccount.EditValue.NullString()))
                {
                ...
                base.m_ResultDB = base.m_DBaccess.ExcuteProc("PKG_SETTING003.PUT_ITEM"
                    ...
                    , new string[] {
                        ...
                        txtGLAccount.EditValue.NullString().Trim(),
                        txtVnName.EditValue.NullString().ToUpper().Trim(),
                ...
                else
                {
                    try
                    {
                        ...
                        if (base.m_ResultDB.ReturnInt == 0)
                        {
                            ...
                            txtGLAccount.EditValue = dt.Rows[0]["CHEMICAL_NAME"].NullString();
                            txtVnName.EditValue = dt.Rows[0]["QUANTITATIVE"].NullString();
